...
let personAge = 28
// тернароное вырожение
let message = personAge < 18                 //  условие
    ? 'Человек еще не совершеннолетний'      // если true то выполняеться это блок
    : 'Человек совершеннолетний'            // если false то выполняеться этот блок
